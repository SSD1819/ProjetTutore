...
# Avec T1 
##Pour les donnees generales avec P1
```{r, echo=FALSE}
...
##Pour les donnees generales avec P2
```{r, echo=FALSE}
...
##Pour les données vectorielles avec P1
```{r, echo=FALSE}
...
##Pour les données avec vecteur avec P2
```{r, echo=FALSE}
cahVec.P2<-hclustvar(X.quanti=dataQVec.P2[,2],X.quali=dataQVec.P2[,-c(1,2)])
plot(cahVec.P2, main="Dendogramme des données avec les vectuers\n de la pedagogie P2")
...
##Pour les données sommées avec P1
...
plot(cahVec8, main="Dendogramme des données avec vecteurs \n de la pedagogieP2 et Q8 regroupée")
rect.hclust(cahVec8,6)
