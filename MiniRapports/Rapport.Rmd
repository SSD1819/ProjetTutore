...
```{r}
#############################################
# Creation environement pour stat. univarie #
#############################################
...
Donc, les tests montrent que dans les réponses à certaines questions `r rownames(subset(d, d[,1] < 0.05))`, il existe des différences significatives entre deux pédagogies. Maintenant, il faut préciser à quelle pédagogie est favorable la différence.
...
par(xpd=TRUE)
legend(2.5,-15,c("P1", "P2"), fill =  c("blue", "green"), box.lwd = 0)
