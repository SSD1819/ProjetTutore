...
barplot(T72, beside = T, col = c("blue", "green"), main="T72 reponses",
...
barplot(T81, beside = T, col = c("blue", "green"), main="T81 reponses",
        legend.text =c("P1","P2"),args.legend = list(x = "top"))
