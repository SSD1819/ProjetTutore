...
Nous avons donc fait le choix de regrouper les questions 8 en 2 groupes, aux vues des résultats. Un groupe comprenant les questions 8.1, 8.2 et 8.3, et un comportant les autres questions 8. Reconnaitre les chiffres 1, 3 et 2 n'entrainerait donc pas la reconnaissance des auters chiffres jusqu'à 9 forcément.
...
Pour la modélisation de chaque regroupement de questions (au-delà, objet, outils), nous obtenons bien la présence d'un effet aléatoire, mais apres selection de variables et tests statistique, seul l'age a une effet fixe significatif sur nos variables à expliquer.
...
$$
\begin{aligned}
Au-delà = -6.19 + 2.493*age\\
Objet = -2.88 + 1.90*age \\
Outils = -0.594 + 0.741*age\\
Q1 = -9.554 + 4.667*age 
\end{aligned}
$$
avec les p.value suivantes pour l'âge :
    - pour le modèle d'Au-dela : 0.0006 et un effet aléatoire avec un écart type de 0.7945316
    - pour le modèle d'Objet : 0.0007 et un effet aléatoire avec un écart type de 0.0003150794
    - pour le modèle d'Outils : 0.0257 et un effet aléatoire avec un écart type de 0.1629329
    - pour la question 1 : 0.0436 et un effet aléatoire avec un écart type de 1.43292
...
\end{aligned}
$$
Avec un écart type des coefficients de l'effet aléatoire pour la Q51 de 0.1416281 et pour la Q89 de 0.1107895.
